    ...
    <div class="flex justify-between items-center">
        <a href="/" class="  mx-2 md:mx-4 my-3 md:my-0 cursor-pointer">
            ...
            <span class="text-xl md:text-3xl cursor-pointer mx-2 md:hidden block">
                <i
                    class="fas fa-bars mx-2 md:mx-4 my-3 md:my-0"
                    " name="
                    menu" onclick="
                    Menu(this)"="Menu(this)""></i>
            </span>
        </div>

        <ul
            class="md:flex md:items-center z-[2] md:z-[2] md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-2 md:pl-0 pl-4 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
            ...
            <li class="mx-2 md:mx-4 my-3 md:my-0">
                <a href="/timesheets">
                    <span class="hover:text-[#737373] duration-500">Manage TimeSheets</span>
                </a >
            </li>
            ...
            <li>
                <form action="/logout" method="POST" class="inline mr-4">
                    ...
                    <button type="submit">
                        ...
                        <span class="hover:text-[#737373] duration-500">Logout</span>
                    </button>
                </form>
            </li>
            @else
            ...
            <li class="mx-2 md:mx-4 my-3 md:my-0">
                <a href="/register">
                    ...
                    <span class="hover:text-[#737373] duration-500">Register</span>
                </a >
            </li>
            <li class="mx-2 md:mx-4 my-3 md:my-0">
                <a href="/login">
                    <i class="fa-solid fa-arrow-right-to-bracket"></i>
                    <span class="hover:text-[#737373] duration-500">Login</span>
                </a >
            </li>
            @endauth
        </ul>
